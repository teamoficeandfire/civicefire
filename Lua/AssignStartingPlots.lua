...
function AssignStartingPlots:PlaceStrategicAndBonusResources()
	...
	local resources_to_place = {
	{self.oil_ID, oil_amt, 35, 1, 1} };
	self:ProcessResourceList(13, 1, self.hills_jungle_list, resources_to_place)
	
	local resources_to_place = {
	{self.oil_ID, oil_amt, 70, 0, 2},
	...
	if self.amounts_of_resources_placed[self.oil_ID + 1] < 8 * self.iNumCivs then
		--print("Map has very low oil, adding another.");
		local resources_to_place = { {self.oil_ID, oil_amt, 100, 0, 0} };
		self:ProcessResourceList(99999, 1, self.hills_jungle_list, resources_to_place)
	end
	if self.amounts_of_resources_placed[self.oil_ID + 1] < 8 * self.iNumCivs then
		--print("Map has very low oil, adding another.");
		local resources_to_place = { {self.oil_ID, oil_amt, 100, 0, 0} };
